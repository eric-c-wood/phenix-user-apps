module phenix-app-autoui

go 1.20

replace phenix => github.com/sandialabs/sceptre-phenix/src/go v0.0.0-20231207195356-afb3cd0934b4

replace phenix-apps => github.com/sandialabs/sceptre-phenix-apps/src/go v0.0.0-20231207150714-fc10ff31695b
